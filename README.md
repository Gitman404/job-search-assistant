...
![Схема workflow](docs/workflow-screenshot.1.jpg)
...
## Текущий статус (v2-n8n)

- ✅ Сбор вакансий с Хабр Карьеры (RSS)
- ✅ Фильтрация по опыту и формату работы
- ✅ Ранжирование по релевантности (AI, no-code, автоматизация)
- ✅ Регулярный дайджест в Telegram
- ✅ Сохранение вакансий в Obsidian (через Google Drive + Junction)
